...
<h3>During Beta our app is free to use with only a few limitations:</h3>
...
Beta Feedback System: A floating button and modal for users to easily submit bug reports and feature requests.
