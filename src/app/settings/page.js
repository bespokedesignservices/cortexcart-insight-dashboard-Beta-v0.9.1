...
import ChartContainer from '@/app/components/ChartContainer'; // Import ChartContainer
...
<script async defer>
  (function() {
    ...
    const API_ENDPOINT = '[https://tracker.cortexcart.com/api/track](https://tracker.cortexcart.com/api/track)';
      ...
      <Layout>
        ...
        <div className="py-8">
            ...
            <div className="max-w-3xl">
                ...
                <form onSubmit={handleSaveSettings} className="mt-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="url" id="siteUrl" value={siteUrl} onChange={(e) => setSiteUrl(e.target.value)} required className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm" placeholder="[https://www.example.com](https://www.example.com)" />
                    </div>
                    <div>
          ...
          {activeTab === 'Recommendations' && (
            <div>
                <h3 className="text-lg font-medium leading-6 text-gray-900">Recommendation Settings</h3>
                <p className="mt-1 text-sm text-gray-600">Configure the recommendation engine. (Coming soon!)</p>
            </div>
          )}
