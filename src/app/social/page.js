...
import { ArrowPathIcon, SparklesIcon, StarIcon, CalendarIcon, AppleTouchIcon, PaperAirplaneIcon, InformationCircleIcon, CakeIcon, UserIcon, GlobeAltIcon, ClipboardDocumentIcon, ChartBarIcon, PencilSquareIcon, XCircleIcon } from '@heroicons/react/24/solid';
...
import { FacebookIcon } from '@heroicons/react/24/solid'; // You might need to create this or use another icon
...
const PLATFORMS = {
    x: { 
        ...
        disabled: false,
        color: '#000000', // Added color for X
        // --- NEW PROPERTY ---
    ...
    facebook: {
        ...
        disabled: false,
        color: '#1877F2', // Added color for Facebook
        // --- NEW PROPERTY ---
    ...
    pinterest: { 
        ...
        disabled: false ,
        color: '#E60023', // Added color for Pinterest
    ...
    instagram: {
        ...
        disabled: false,
        color: '#E4405F' // Added color for Instagram
    }
};
...
const AnalyticsTabContent = () => {
    ...
    const [syncMessageType, setSyncMessageType] = useState('info'); // 'info', 'success', or 'error'
     const [isSyncing, setIsSyncing] = useState({ x: false, facebook: false });
    ...
    const reachChartData = dailyReach.map(item => ({
     ...
     const engagementByPlatformData = {
        ...
        datasets: [{
            ...
            // This logic now ensures any invalid number becomes 0.
            ...
            <h3 className="text-2xl font-bold text-gray-800">Social Media Analytics Overview</h3>
                <div className="flex gap-x-2">
                     <button
                        ...
                        disabled={isSyncing.x}
                        className="inline-flex items-center rounded-md bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-800 disabled:bg-gray-400"
                    >
                    ...
                    <button
                        onClick={() => handleSync('pinterest')}
                        disabled={isSyncing.pinterest}
                        className="inline-flex items-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-700 disabled:bg-red-400"
                    >
